...
<head>
    ...
    <title><spring:message code="assist.Uncompl.user.orders"/></title>
...
<div id="wrap">
    ...
    <div>
        <p id="hello" class="top-block"><spring:message code="assist.My.Uncompl.user.orders"/></p>
    </div>

    <div>
        <form class="form-horizontal" method="get" action="/ComplOrders">
            <button id="assist_user_Compl_1" class="btn btn-primary btn-block">
                <spring:message code="assist.Compl.user.orders"/></button>
        </form>
    </div>
