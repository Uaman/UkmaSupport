...
<head>
    ...
    <title><spring:message code="assist.My.orders"/></title>
...
<div id="wrap">
    ...
    <div>
        <p id="hello" class="top-block"><spring:message code="assist.My.User.orders"/></p>
    </div>

    <div>
        <form class="form-horizontal" method="get" action="/ComplOrders">
            <button id="assist_user_Compl" type="submit" class="btn btn-primary btn-block">
                <spring:message code="assist.Compl.user.orders"/>
            </button>
        </form>
    </div>
    ...
    <div>
        <form class="form-horizontal" method="get" action="/UncomplOrders">
            <button id="assist_user_Uncompl" type="submit" class="btn btn-primary btn-block">
                <spring:message code="assist.Uncompl.user.orders"/>
            </button>
        </form>
    </div>
